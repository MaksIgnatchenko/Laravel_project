    ...
    <div class="col-sm-10 col-md-8 col-sm-offset-1 col-md-offset-2 loginpage-wrapper">
        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-social-login">
                <form method="post">
                    <p class="litel1"><a href="{{url('auth/github')}}">Войти через Github<i class="fa fa-github" aria-hidden="true"></i></a></p>
                    <p class="litel1"><a href="{{url('auth/google')}}">Войти через Google<i class="fa fa-google " aria-hidden="true"></i></a></p>
                    <p class="litel1"><a href="{{url('auth/facebook')}}">Войти через Facebook<i class="fa fa-facebook " aria-hidden="true"></i></a></p>
                    <input type='hidden' name='csrfmiddlewaretoken' value='nWvVfQWhK1LeUef98KhlcYRhxgPS4nIPGS2z26NSg3LvNhvmbEfiOJYGjY8dgqSk' />
                </form>
            </div>
        </div>
